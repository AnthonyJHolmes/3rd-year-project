<%-- 
    Document   : addGroup
    Created on : 27-Feb-2015, 15:04:42
    Author     : ajh3
--%>
...
<%              //Get the parameters of what the user has entered previously
                String groupName   = request.getParameter("group_name");
                String userIDS = request.getParameter("user_ids");
                String year        = request.getParameter("year");
                String users[] = userIDS.split(" ");//splitting the ID's by the regular expression of a space
                ...
                out.println("Requests sent to the following users");
                for(String u : users){
                    out.println(u);//print out the list of users
                    //insert a notification for each member listed
                    db.Insert("INSERT INTO notifications(user_id, creator_id, group_name, year) VALUES("+u+","+userID+",'"+groupName+"',"+year+");");
