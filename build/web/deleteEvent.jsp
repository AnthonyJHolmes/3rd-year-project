...
<%              //set up the database
                ...
                //get the parameter for what the user selected in the previous page.
                String description = request.getParameter("description");
                //delete the event
                String query = "DELETE FROM User_events "
                        + "WHERE Student_or_staff_number ="+userID+" AND Description = '"+description+"' ;";
                db.Delete(query);
                
                out.println("Event deleted : "+ description);
