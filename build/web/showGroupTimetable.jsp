...
//full calendar for the group
            $(document).ready(function() {
                ...
                $('#calendar').fullCalendar({
                    ...
                    eventSources: [ // just the one colour to show all the clashes of events.
                        {
                            url: '/GroupJsonServlet',
                            color: 'red'
                        }
                    ]
        ...
        <script>
        $(function() {
//wouldnt work on the hosting site so a manual enter of a date must be submitted
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <% 
                            //get the parameter of the group you have selected
