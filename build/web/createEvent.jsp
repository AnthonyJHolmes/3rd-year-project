...
<html>
    <head>
        ...
        <script>
    //was hoping this would work but it didnt in the hosting site
    //worked as a separate component when used in my cs1 public html folder.
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                <small>Create Personal Event</small>
                            </h1>
                            <form class="form-horizontal" action="addEvent.jsp" method="post">
                                <fieldset>

                                    <!-- Form for which  a user can create a personal event -->
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label" for="description">Event Description</label>
                                        <div class="col-md-4">                     
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input id="datepicker" name="datepicker" type="text" placeholder="yyyy-mm-dd" class="form-control input-md" >
                            ...
                            <form class="form-horizontal" action="deleteEvent.jsp" method="post">
                                <fieldset>
                                    <legend> Delete Event</legend>
                                <%
                            //set up the database for deleting an event
                                    ...
                                    String[] arrayOfDescription = null;
                                    //get all of the events listed for the user.
                                    arrayOfDescription = db.SelectColumn("SELECT Description FROM User_events WHERE Student_or_staff_number = '" + userID + "' ");
                                %> <div class="form-group">
                                    <label class="col-md-4 control-label" for="description">Select Event to Delete</label>
                                    <div class="col-md-4">
                                        <select id="endTime" name="description" class="form-control">
                                            <% //output the list in the form of a dropdown box
                                    for (String description : arrayOfDescription) {%>
