                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                <small>Select Group Event</small>
                            </h1>
                          <% //set up the database. Get all the group names that you are currently in
                             foo.DatabaseClass dbclass = new foo.DatabaseClass();
                              ...
                              String[] Groups = dbclass.SelectColumn("SELECT DISTINCT Group_name FROM Groups WHERE ID_number ="+userID+";");
                    
                    %>
                    
                       <div class="panel panel-info">
                        <div class="panel-heading">
                                <h3 class="panel-title">Select the group you would like to make a meeting with.</h3>
                        </div>
                           
                           <div class="panel-body">
                                <form action="showGroupTimetable.jsp" role="form">
                                    <div class="form-group">
                                        <label class="col-md-4 control-label" for="group_name">Select Group</label>
                                        <div class="col-md-4"> 
                                     <select class="form-control" name="group_name">
                                         <%
                              //list all the groups you are currently in, in the form of a drop down list
